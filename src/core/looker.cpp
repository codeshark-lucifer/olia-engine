...
void Looker::Update(const float &deltaTime)
{
        ...
        return;
    {
        ...
        en->rotation = glm::normalize(qYaw * en->rotation * qPitch);
    }

    { // Get local axes
        glm::vec3 forward = en->forward();
        glm::vec3 right = en->right();
        ...
        // Apply movement
        en->position += direction * speed * deltaTime;
    }
